...
!
    ...
    SUBROUTINE PETR90(x,b,n,matvec, cmatvec, cg)
...
!     .. Local Arrays ..
      COMPLEX (wp), allocatable :: qi(:), gi(:), pi(:), cr(:), axi(:), r(:), ace(:)
!     .. External Functions ..
...
!     .. Intrinsic Functions ..
      ...
      ioerr=cg%ioerr
      print*, maxiter, epsilon_err, ioerr
...
! Compute residual vector |RI>=A|XI>-|B>
 ...
 50 continue
      ...
      deallocate(qi, gi, pi, cr, axi, r, ace, STAT=dealloc_error)
        ...
        END IF
      RETURN
    END SUBROUTINE PETR90


    SUBROUTINE cgsqr(cx,cy,n,matvec, cg)
      USE ddprecision, ONLY : wp
      use cgmodule
      implicit none
      type (cgstruct) cg
...
!     .. Local Scalars ..
      ...
      REAL (wp) :: rnorm, ynorm
 !     .. Local Arrays ..
      COMPLEX (wp),allocatable:: aw(:), cax(:), p(:), q(:), r(:), r0(:), u(:), v(:), w(:)
!     .. External Functions ..
!     .. External Subroutines ..
      EXTERNAL matvec
!     .. Intrinsic Functions ..
...
60    CONTINUE
      ...
      RETURN
    END SUBROUTINE cgsqr

    SUBROUTINE cgstab(cx,cy,n,matvec, cg)
      USE ddprecision, ONLY : wp
      use cgmodule
      implicit none
      type (cgstruct) cg
...
!     .. Local Scalars ..
      ...
      REAL (wp) :: rnorm, ynorm
!     .. Local Arrays ..
      COMPLEX (wp), allocatable,dimension(:)  :: cax, p, r, r0, s, t, v
!     .. External Functions ..
!     .. External Subroutines ..
      EXTERNAL matvec
!     .. Intrinsic Functions ..
...
60    CONTINUE
    ...
    END SUBROUTINE cgstab
        ...
        SUBROUTINE cors(x,b,n,matvec, cg)
!
...
!	INTEGER ja(*),ia(*)
        ...
        INTEGER ios        
        COMPLEX(wp), allocatable, dimension(:) ::  p,q_hat,q,r_hat,r,y                
        COMPLEX(wp), allocatable, dimension(:) ::  p_hat,s_hat,s                        
        COMPLEX(wp), allocatable, dimension(:) ::  r_s,t,tmp,tmp1
	COMPLEX(wp), allocatable, dimension(:) ::  f,z,q1,e,ze,d,zh,h                         
        COMPLEX(wp) zero, one
        external matvec
        INTRINSIC cmplx
